...
quantile(fourtype_ymd$LONGITUDE_X, c(.005, .57, .995)) 
...
fourtype_ymd_995<-
  ...
  filter(LATITUDE_X > 39.06, LONGITUDE_X > -84.7) %>%
  filter(LATITUDE_X < 39.28, LONGITUDE_X < -84.37) 
  
```
```{r}
summary(fourtype_ymd_995$LATITUDE_X)
summary(fourtype_ymd_995$LONGITUDE_X)
